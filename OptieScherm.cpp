...
//	this->roodLabel = new Label (0,0,100,100,NULL,"test",0,font);
//	this->groenLabel = new Label (0,0,100,100,NULL,"test2",0,font);
//	this->lijstKleuren = new ListBox (screenWidth/2-50, 155, 80, 30, label);
//	lijstKleuren->add(roodLabel);
//	lijstKleuren->add(groenLabel);
//	lijstKleuren->update();
	...
	this->imageTekst = new EditBox( 50, 50, 150, 30, label, "Mooi plaatje", 0x555500, font, true, false, 20, EditBox::IM_STANDARD );
